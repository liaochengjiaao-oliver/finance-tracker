...
| 年度理财 PDF 报告 | 理财 | 年度理财收益、本金变动、月度明细 |

### 3.10 理财管理

- 记录理财资金操作：追加本金、取出本金、收益入账
- 汇总展示：当前本金、累计收益、理财总资产、年化收益率（XIRR）
- 操作记录列表（分页、删除）
- 本金趋势折线图
- 收益趋势图（月收益柱状图 + 累计收益折线图）
- 年度理财汇总：年度收益、本金变动、年化收益率、同比去年，月度明细柱状图
- 年度理财 PDF 报告导出
...
- 支持中文和英文界面
- 切换入口：侧栏底部用户旁的胶囊按钮（显示目标语言文字，如 "EN" 或 "中"）
- 预设分类名称随语言切换显示对应翻译（如 餐饮 → Food）
- 语言偏好持久化到 config.json，重启后保持
